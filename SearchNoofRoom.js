...
// document.getElementById("2-room").onchange = Room2Search;

// console.log(document.getElementById("2-room"));

// document.getElementById("1-room").onchange = Room1Search;

// document.getElementById("4-room").onchange = Room4Search;

// console.log(document.querySelectorAll(".noofroom"));
...
// function Room3Search(event) {
//   if (event.target.checked) {
//     const FilteredArrayOnly3Room = HousesArrayData.filter(
//       (House) => House.noOfRooms === 3
//     );

//     console.log(FilteredArrayOnly3Room);
...
//       FilteredArrayOnly3Room.map((house) => {
//         // Create a new div element for each house
//         const homeElement = document.createElement("div");
//         homeElement.classList.add("home");
//         // Add the "home" class to the new elements
...
// function Room2Search(event) {
//   if (event.target.checked) {
//     const FilteredArrayOnly2Room = HousesArrayData.filter(
//       (House) => House.noOfRooms === 2
//     );

//     console.log(FilteredArrayOnly2Room);

//     if (FilteredArrayOnly2Room.length <= 0) {
//       const homesElement = document.querySelector(".homes");

//       // console.log(homesElement);

//       homesElement.innerHTML = "<h1>No Data</h1>";
...
//       FilteredArrayOnly2Room.map((house) => {
//         // Create a new div element for each house
//         const homeElement = document.createElement("div");
//         homeElement.classList.add("home");
//         // Add the "home" class to the new elements
...
//     console.log(FilteredArrayOnly1Room);
...
//       FilteredArrayOnly1Room.map((house) => {
//         // Create a new div element for each house
//         const homeElement = document.createElement("div");
//         homeElement.classList.add("home");
//         // Add the "home" class to the new elements
...
function Room1andRoom2Search(event) {
  console.log(typeof event.target.id.split("-")[0]);
